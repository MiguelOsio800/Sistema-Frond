...
import { PlusCircleIcon, TrashIcon, SaveIcon, XCircleIcon, PrinterIcon, ShieldCheckIcon } from '../icons/Icons';
import ClientSearchInput from './ClientSearchInput';
import { calculateFinancialDetails } from '../../utils/financials';


const initialClientState: Partial<Client> = { id: '', idNumber: '', name: '', phone: '', address: '', clientType: 'persona' };
        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <div className="flex flex-wrap space-x-2">
                    ...
                    <Button variant="secondary"><PrinterIcon className="w-4 h-4 mr-2" />Imprimir</Button>
