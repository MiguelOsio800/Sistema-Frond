...
const LoginView: React.FC<LoginViewProps> = ({ onLogin, users, companyInfo }) => {
  ...
  const handleUsernameChange = (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      // If a user was remembered on load and the new username is different,
      // uncheck "remember me" as it's a different user.
