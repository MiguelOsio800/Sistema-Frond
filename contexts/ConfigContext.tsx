...
type ConfigContextType = {
    ...
    handleCompanyInfoSave: (info: Partial<CompanyInfo>) => Promise<void>;
...
export const ConfigProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const handleCompanyInfoSave = async (info: Partial<CompanyInfo>) => {
        try {
    ...
    const handleSaveUser = async (user: Partial<User>) => {
        ...
        // Tu lógica de permisos original se mantiene...
        try {
            if (isUpdating) {
    ...
    const onDeleteRole = async (roleId: string) => {
        // Tu lógica de negocio original se mantiene...
        try {
